...
5. Rename the extracted folder from `super-ai-ml-agents-main` to `super-ai-ml-agents`.
6. Copy the renamed `super-ai-ml-agents` folder into your agent's skills directory.
...
This repository is the `super-ai-ml-agents` skill. Keep the full `super-ai-ml-agents` folder together when installing it.
